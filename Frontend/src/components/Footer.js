    ...
    return (
        <div className="w-screen h-80 pt-8 flex absolute h-48 bg-white  border-t-2">
            <ul className="ml-16 mt-8 p-2 text-blue-800 font-black text-lg list-disc">
                <li className="mb-4 hover:text-red-500"><Link>Hakkımızda</Link></li>
                <li className="mb-4 hover:text-red-500"><Link>Ofislerimiz</Link></li>
                <li className="mb-4 hover:text-red-500"><Link>Araçlar</Link></li>
            </ul>
